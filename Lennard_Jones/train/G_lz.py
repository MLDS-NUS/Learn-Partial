...
from utils.dataset import EnsembleStrategy
...
parser.add_argument('--num_tra', default=5, type=int)
...
if __name__ == "__main__":
    ...
    strategy = EnsembleStrategy(AE_folder=args.AE_folder, fold=args.fold,  \
